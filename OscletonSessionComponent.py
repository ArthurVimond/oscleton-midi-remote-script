...
from .OscletonSceneComponent import OscletonSceneComponent


class OscletonSessionComponent(SessionComponent, OscletonMixin):
    scene_component_type = OscletonSceneComponent

    @wrap_init
    def __init__(self, *args, **kwargs):
        self._scene_count = -1
        self._scenes_count = 0
        super(OscletonSessionComponent, self).__init__(*args, **kwargs)
    ...
    def _create_scene(self):
        ...
        sc = self.scene_component_type(num_slots=self._num_tracks, tracks_to_use_callback=self.tracks_to_use,
                                       id=self._scene_count)
    ...
    # Scene Callbacks
    def _scene_name_block(self, msg):
