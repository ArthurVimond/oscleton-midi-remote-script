...
class OscletonParameterComponent(ControlSurfaceComponent, OscletonMixin):
    ...
    def _on_value_changed(self):
        ...
        if self._is_send:
            ...
            self.send('/live/' + self._track_types[ty] + 'send', tid, track_name, s, return_track_name, send_value,
                      send_display_value, send_state, automation_state)
            ...
            self.send('/live/' + self._track_types[ty] + 'device/param', tid, d, p, track_name, device_name,
                      str(self._parameter.name), param_display_value, param_value, param_min, param_max,
                      automation_state)
